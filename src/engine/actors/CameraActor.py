...
class CameraActor(Actor):
    ...
    def _isObserved(self, xCoord: int, yCoord: int) -> bool:
        ...
        return xCoord in range(
            xCoord - self._xHalfHeightObserved, xCoord + self._xHalfHeightObserved + 1
        ) and yCoord in range(yCoord - self._yHalfWidthObserved, yCoord + self._yHalfWidthObserved + 1)
    ...
    def _composeDataForCameraView(self) -> dict[View, tuple[int, int]]:
        ...
        for actor in self._observedActors():
            ...
            cameraViewData[actor.view()] = (
                xCoordRelative - xCoord + self._xHalfHeightObserved,
    ...
    def setFOV(self, fov: tuple[int, int]) -> None:
        ...
        self._cameraView.setResolution(self._xHalfHeightObserved * 2 + 1, self._yHalfWidthObserved * 2 + 1)
